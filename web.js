...
// ==========================================
// [통합] 오프라인 좌수왕(C) + 매니저 관리(D) 시스템
// ==========================================

const adminCollectionName = 'admin_managers'; // 관리자가 수동 등록한 매니저 목록
...
app.get('/api/jwasu/dashboard', async (req, res) => {
    try {
        ...
        // 여기서 OFFLINE_STORES 변수를 사용하므로 상단 선언이 필수입니다.
